...
local function class_constructor(name,class, super, ...)
    ...
    rawset(_G,name,class_tpl)
    return class_tpl
end

function class(name,super, ...)
    return class_constructor(name, {}, super, ...)
end

function singleton(name,super, ...)
    return class_constructor(name , { __singleton = true }, super, ...)
end
